...
public class RtpPacket {
	private final static String TAG = "RtpPacket";
	...
	public byte[] getPacket() {		
		Log.d(TAG, "getPacket() " + packet_len);
		return packet;
	}
...
//	Total 12 bytes
	...
	/** Gets the sequence[序列] number 
	 * return 0 if broken packet */
	public int getSequenceNumber() {
		if (packet_len >= 12) /* RTP包头长12个字节 ，小于12表示非法的数据包  */
